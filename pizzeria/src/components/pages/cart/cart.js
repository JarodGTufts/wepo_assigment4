...
// This page represents the users cart
class Cart extends React.Component {
    ...
    render() {
        ...
        // These are just temporary example items - this content NEEDS TO BE FILLED
        // with items that the user adds to their cart from the Menu or Offers pages.
        // To do so, it needs to be connected to the global store (which I have yet to make)
        var temp_spoofin = [
